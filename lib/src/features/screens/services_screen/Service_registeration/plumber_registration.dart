...
class PlumberRegistrationPage extends StatefulWidget {
  @override
  _PlumberRegistrationPageState createState() => _PlumberRegistrationPageState();
}
...
class _PlumberRegistrationPageState extends State<PlumberRegistrationPage> {
      ...
      try {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Success'),
              content: Text('Plumber service registered successfully!'),
              actions: <Widget>[
                TextButton(
                  onPressed: () {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Error'),
              content: Text('Failed to register Plumber service. Please try again later.'),
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    Navigator.of(context).pop();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Register for Plumber Service'),
        centerTitle: true,
      ),
      body: Padding(
